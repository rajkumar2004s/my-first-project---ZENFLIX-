<template>
  <div class="pt-22 md:pt-24 md:pl-26 md:pr-24 md:pb-6">
    <h1 class="text-white text-xl pl-2">Top Rated Movies</h1>
    <div class="md:flex md:flex-wrap md:gap-2 grid grid-cols-2 pt-1 pb-4">
